...
const prompts = [
    ...
    ["trust in Canada","ngos in Canada"],
    ["tell joke"],
  ...
  const replies = [
    ["Hello Donor!", "Hi Donor!", "Hey Donor!", "Hi there!","Howdy Donor"],
    ...
    ["Haha!","Good one!"],
    ["  The basic concept of this project  Howdy Donor is to collect the donations from donors and distribute to  the  needy people"],
    [currentdate],
    [time],
